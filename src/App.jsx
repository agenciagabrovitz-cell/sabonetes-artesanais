  ...
  return (
    <div className="min-h-screen font-inter bg-dark text-white selection:bg-primary selection:text-white pb-0">
      ...
      <section className="bg-[#0a0a0a] pt-[80px] pb-[120px] px-[20px] flex flex-col items-center relative overflow-hidden">
        ...
        <div className="absolute bottom-[-1px] left-[-0.5%] w-[101%] overflow-hidden leading-[0] transform rotate-180 z-10">
          <svg className="relative block w-full h-[80px] scale-x-105" viewBox="0 0 1200 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section className="bg-white py-[120px] px-[20px] flex flex-col items-center relative overflow-hidden">
        ...
        <div className="absolute bottom-[-1px] left-[-0.5%] w-[101%] overflow-hidden leading-[0] z-10">
          <svg className="relative block w-full h-[100px] scale-x-105" viewBox="0 0 1200 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.05,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.07,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,103.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.05c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5V120H0Z" fill="#0D0D0D"></path>
          </svg>
        </div>
      </section>
      ...
      <div className="w-[101%] left-[-0.5%] overflow-hidden leading-[0] bg-[#111] z-10 relative">
        <svg className="relative block w-full h-[80px] scale-x-105" viewBox="0 0 1200 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,0V5.63C149.93,59,314.09,71.32,475.83,42.57c43-7.64,84.23-20.12,127.61-26.46,59-8.63,112.48,12.24,165.56,35.4C827.93,77.22,886,95.24,951.2,90c86.53-7,172.46-45.71,248.8-84.81V120H0Z" fill="#f0f2f5"></path>
        </svg>
      </div>
